...
func TestFetchSnapshot_Success(t *testing.T) {
	...
	// Create client
	client := NewElchiClient(server.URL, "gslb.elchi", "test-secret", 5*time.Second)
...
func TestFetchSnapshot_Timeout(t *testing.T) {
	...
	client := NewElchiClient(server.URL, "gslb.elchi", "test-secret", 100*time.Millisecond)
...
func TestSignRequest(t *testing.T) {
	...
	client := NewElchiClient(server.URL, "gslb.elchi", "my-secret-key", 5*time.Second)
